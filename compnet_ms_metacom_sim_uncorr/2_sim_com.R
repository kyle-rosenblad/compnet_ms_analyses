...
disp_vals <- data.frame(disp_val=c(0.0001, 0.001, 0.01, 0.1))
nb_vals <- data.frame(nb_val=c(0.001, 0.01, 0.1, 1, 10))
param_levels <- merge(disp_vals, nb_vals)

rep <- data.frame(rep=c(1:30))
param_levels <- merge(param_levels, rep)
saveRDS(param_levels, "param_levels.RDS")
